 ...
 <div class="container">
     <div class="row">
         <div class="col-xs-8 col-xs-offset-2" style="font-family: 'Kanit', sans-serif;">
            <br><br>
            <legend>ตรวจสอบสถานะลูกค้า</legend>
            </div>
                 ...
                 <?php
                  ...
                  while ($row = mysqli_fetch_array($result)) { ?>
                        <tr>
                            ...
                            <td  align="center">
                                     <a class="btn btn-success" href="delete_order_send.php?id=<?php echo $row["no"];?>" onclick="return confirm('คุณแน่ใจ ?')";>เสร็จสิ้น</a>
                            </td>
                        </tr>
                 <?php }?>
             ...
             <table class="table table-hover">
                 <thead>
                     <tr>
                         ...
                         <th>ยอดรวม</th>
                         <th>สถานะ</th>
                         <th>สถานะการจ่ายเงิน/ส่งของ</th>
                         <th>เสร็จสิ้นเรียบร้อย</th>
                     </tr>
                 </thead>
                 <tbody>
                 ...
                 <?php
                  ...
                  while ($row = mysqli_fetch_array($result)) { ?>
                        <tr>
                            ...
                            <td align="center">
                                <a class="btn btn-warning" href="order_status.php?id=<?php echo $row["no"];?>">สถานะ</a>
                            </td>
                            <td  align="center">
                                     <a class="btn btn-success" href="delete_order_success.php?id=<?php echo $row["no"];?>" onclick="return confirm('คุณแน่ใจ ?')";>เสร็จสิ้น</a>
                            </td>
                        </tr>
                 <?php }?>
