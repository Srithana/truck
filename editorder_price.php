 ...
 <div class="container">
	<div class="row">
		<div class="col-md-4 col-md-offset-4 well" style="font-family: 'Kanit', sans-serif; font-size: 16px;">
			<form method="post" id="form" enctype="multipart/form-data" action="action_editorder.php?id=<?php echo $row["no"];?>"></a>
			<?php if($id!=''){?>
		...
		<!-- แก้ไขราคา -->
                    ...
                    <div class="form-group">
						...
						<input type="text" name="face_soil" placeholder="" minlength="" required class="form-control" value="<?php echo $row['face_soil'];?>" /> 
						<span class="text-danger"></span> 
					</div>
