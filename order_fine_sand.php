        ...
        <div class="w3-top">
			<div class="w3-bar w3-white w3-padding w3-card" style="letter-spacing:4px;">
              ...
              <a href="user.php" class="w3-bar-item w3-button"><font face="Kanit" >หน้าสั่งสินค้า</font></a>
				<a href="index.php" class="w3-bar-item w3-button"><font face="Kanit">ล็อคเอาท์</font></a>
			  </div>
			</div>
		  </div>
		...
		<div class="container">
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<br><br><br><br>
							<img class="img-fluid" src="images/category/fine_sand.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<div class="col-lg-5 offset-lg-1">
					...
					<form role="form" action="action_sand_fine.php?user_name=<?php echo $_SESSION['user_name']; ?>" method="post" name="updateform">
					<h3><font face="Kanit" font size="6">ทรายละเอียด</font></h3>
						<div class="s_product_text">
						...
						<h2><?php echo $row['fine_sand'] ?>฿</h2>
						<input type="hidden" name="fine_sand" placeholder=""  class="form-control" value="<?php echo $row['fine_sand'] ?>" />
                        <?php }?>
						<div class="form-group" style="font-family: 'Kanit', sans-serif; font-size: 16px;">
							...
							<select class="form-control" name="type" required class="form-control">
								<option face="Kanit" value="ทรายละเอียด" >ทรายละเอียด</option>
							</select>
							<span class="text-danger"></span>
						</div>
						<br>
