				...
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<br><br><br><br>
							<img class="img-fluid" src="images/category/dan_soil.jpg" alt="">
						</div>
					</div>
				</div>
				<div class="col-lg-5 offset-lg-1">
				<form role="form" action="action_soil_dan.php?user_name=<?php echo $_SESSION['user_name']; ?>" method="post" name="updateform">
					<div class="s_product_text">
						<h3><font face="Kanit" font size="6">ดินดาน</font></h3>
						<div class="s_product_text">
						...
						<h2><?php echo $row['dan_soil']; ?> ฿</h2>
						<input type="hidden" name="dan_soil" placeholder=""  class="form-control" value="<?php echo $row['dan_soil'] ?>" />
						...
						<div class="form-group" style="font-family: 'Kanit', sans-serif; font-size: 16px;">
							...
							<select class="form-control" name="type" required class="form-control">
								<option face="Kanit" value="ดินดาน" >ดินดาน</option>
							</select>
							<span class="text-danger"></span>
						</div>
						<br>
						<h5><a><font face="Kanit" font size="4">กรุณากรอกวัน - เวลาที่สั่ง</font></a></h5>
						<p><input class="w3-input w3-padding-16 w3-border" required="" type="datetime-local" placeholder="Date and time"  name="date_o" value="2020-02-21 :"></p>
						<h5><font face="Kanit" font size="4">กรุณากรอกวัน - เวลาที่ส่ง</font></h5>
						<p><input class="w3-input w3-padding-16 w3-border" required="" type="datetime-local" placeholder="Date and time" name="date_s" value="2020-02-21 :"></p>
