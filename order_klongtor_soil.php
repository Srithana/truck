	...
	<div class="product_image_area">
		<div class="container">
			<div class="row s_product_inner">
				...
				<form role="form" action="action_soil_klongtor.php?user_name=<?php echo $_SESSION['user_name']; ?>" method="post" name="updateform">
					<div class="s_product_text">
						...
						<h2><?php echo $row['klongtor_soil'] ?>฿</h2>
						<input type="hidden" name="klongtor_soil" placeholder=""  class="form-control" value="<?php echo $row['klongtor_soil'] ?>" />
                        <?php }?>
						<div class="form-group" style="font-family: 'Kanit', sans-serif; font-size: 16px;">
							...
							<select class="form-control" name="type" required class="form-control">
								<option face="Kanit" value="ดินคลองต่อ" >ดินลูกรังขี้หนู</option>
							</select>
							<span class="text-danger"></span>
						</div>
						<br>
