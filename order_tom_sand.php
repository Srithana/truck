	...
	<div class="product_image_area">
		<div class="container">
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<br><br><br><br>
							<img class="img-fluid" src="images/category/tom_sand.jpg" alt="">
						</div>
						<!-- <div class="single-prd-item">
				...
				<form role="form" action="action_sand_tom.php?user_name=<?php echo $_SESSION['user_name']; ?>" method="post" name="updateform">
				<h3><font face="Kanit" font size="6">ทรายถม</font></h3>
						...
						<h2><?php echo $row['tom_sand'] ?>฿</h2>
						<input type="hidden" name="tom_sand" placeholder=""  class="form-control" value="<?php echo $row['tom_sand'] ?>" />
                        <?php }?>
						<div class="form-group" style="font-family: 'Kanit', sans-serif; font-size: 16px;">
							...
							<select class="form-control" name="type" required class="form-control">
								<option face="Kanit" value="ทรายถม" >ทรายถม</option>
							</select>
							<span class="text-danger"></span>
						</div>
						<br>
