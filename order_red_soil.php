				...
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							...
							<img class="img-fluid" src="images/category/red1_soil.jpg" alt="">
						</div>
					</div>
				</div>
				<div class="col-lg-5 offset-lg-1">
				<form role="form" action="action_soil_red.php?user_name=<?php echo $_SESSION['user_name']; ?>" method="post" name="updateform">
					<div class="s_product_text">
						<h3><font face="Kanit" font size="6">ดินลูกรัง</font></h3>
						<div class="s_product_text">
						...
						<h2><?php echo $row['red_soil'] ?>฿</h2>
						<input type="hidden" name="red_soil" placeholder=""  class="form-control" value="<?php echo $row['red_soil'] ?>" />
                        <?php }?>
						<div class="form-group" style="font-family: 'Kanit', sans-serif; font-size: 16px;">
							...
							<select class="form-control" name="type" required class="form-control">
								<option face="Kanit" value="ดินลูกรัง" >ดินลูกรัง</option>
							</select>
							<span class="text-danger"></span>
						</div>
						<br>
