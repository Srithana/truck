				...
				<div class="col-lg-6">
					<div class="owl-carousel owl-theme s_Product_carousel">
						<div class="single-prd-item">
							<br><br><br><br>
							<img class="img-fluid" src="images/category/kook_rock.jpg" alt="">
						</div>
					</div>
				</div>
				<div class="col-lg-4 offset-lg-1">
				<form role="form" action="action_rock_kook.php?user_name=<?php echo $_SESSION['user_name']; ?>" method="post" name="updateform">
				<h3><font face="Kanit" font size="6">หินคลุก</font></h3>
						...
						<h2><?php echo $row['kook_rock'] ?>฿</h2>
						<input type="hidden" name="kook_rock" placeholder=""  class="form-control" value="<?php echo $row['kook_rock'] ?>" />
                        <?php }?>
						<div class="form-group" style="font-family: 'Kanit', sans-serif; font-size: 16px;">
							...
							<select class="form-control" name="type" required class="form-control">
								<option face="Kanit" value="หินคลุก" >หินคลุก</option>
							</select>
							<span class="text-danger"></span>
						</div>
						<br>
