 ...
 <div class="container">
	<div class="row">
		<div class="col-md-4 col-md-offset-4 well" style="font-family: 'Kanit', sans-serif; font-size: 16px;">
			<form method="post" id="form" enctype="multipart/form-data" action="action_order_send.php?id=<?php echo $row["no"];?>"></a>
				<fieldset>
					<legend>ดิน</legend>
		...
		<!-- แก้ไขข้อมูล -->
                    ...
                    <div class="form-group">
						...
						<input type="text" name="send" placeholder=""  class="form-control"  />
						<span class="text-danger"></span>
					</div>
